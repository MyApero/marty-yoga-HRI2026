def variance_feedback(actual_run):
    """
...
def get_errors_over_time(actual_run, time, max_error):
    error_timeline = {}
...
def get_feedbacks_from_run(actual_run, time, max_error):
    ...
    """
    variance = variance_feedback(actual_run)
    validity = get_pose_validity(actual_run)
